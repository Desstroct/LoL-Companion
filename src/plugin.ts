...
streamDeck.actions.registerAction(new TeamComp());
streamDeck.actions.registerAction(new LobbyLevelTracker());
streamDeck.actions.registerAction(new DodgeAdvisor());
...
streamDeck.actions.registerAction(new PowerSpike());
